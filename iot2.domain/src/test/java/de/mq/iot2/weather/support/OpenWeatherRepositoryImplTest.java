...
class OpenWeatherRepositoryImplTest {
	...
	private final Converter<Map<String, Object>, MeteorologicalData> meteorologicalDataConverter = Mockito
	...
	private final WeatherRepository weatherRepository = new OpenWeatherRepositoryImpl(restOperations,
			meteorologicalDataConverter, city, country, key);

	@Test
	void forecast() {
		final var meteorologicalDataCurrentDay = new MeteorologicalDataImpl(0, 0, 0, 0, 0, ZonedDateTime.now());
		final var meteorologicalDataNextDay = new MeteorologicalDataImpl(1, 1, 1, 1, 1,
		...
		Mockito.when(restOperations.getForObject(OpenWeatherRepositoryImpl.OPEN_WEATHER_FORE_CAST_URL, Map.class,
				Map.of(OpenWeatherRepositoryImpl.PARAMETER_CITY, city, OpenWeatherRepositoryImpl.PARAMETER_COUNTRY,
						country, OpenWeatherRepositoryImpl.PARAMETER_KEY, key)))
