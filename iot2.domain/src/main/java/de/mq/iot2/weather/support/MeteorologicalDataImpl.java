...
class MeteorologicalDataImpl implements Comparable<MeteorologicalData>, MeteorologicalData {
	...
	/*
	 * Degrees from north, right rotating over east (90°) , south (180°) ,
	 * west(270°).
	 */
	private final double windVelocityAngleInDegrees;

	MeteorologicalDataImpl(final double lowestTemperature, final double temperature, final double highestTemperature, final double windVelocityAmount,
			final double windVelocityAngleInDegrees, final ZonedDateTime dateTime) {
