...
CREATE TABLE PARAMETER (
  CONFIGURATION_RULE_KEY VARCHAR(15)   NOT NULL ,
  ...
  FOREIGN KEY(CONFIGURATION_ID, CONFIGURATION_RULE_KEY)
    REFERENCES CONFIGURATION(ID, RULE_KEY));


CREATE INDEX FK_PARAMETER_CONFIGURATION ON PARAMETER (CONFIGURATION_ID, CONFIGURATION_RULE_KEY);
CREATE UNIQUE INDEX PARAMETER_CONFIGURATION_ID_KEY ON PARAMETER (PARAMETER_KEY, CONFIGURATION_ID);
...
CREATE INDEX FK_CYCLE_PARAMETER_CONFIGURATION_ID ON CYCLE_PARAMETER (CONFIGURATION_ID, CONFIGURATION_RULE_KEY);
