...
CREATE INDEX FK_BATCH_EXECUTION_CONFIGURATION_ID ON BATCH_EXECUTION (CONFIGURATION_ID);
CREATE INDEX BATCH_EXECUTION_CONFIGURATION_ID_TIME ON BATCH_EXECUTION (CONFIGURATION_ID, TIME);


CREATE INDEX IFK_Configuration2BatchEcecuti ON BATCH_EXECUTION (CONFIGURATION_ID);
...
CREATE INDEX IFK_Timer2DayGroup ON DAY_GROUP (CYCLE_ID);
...
CREATE INDEX IFK_Configuration2Parameter ON PARAMETER (CONFIGURATION_ID);
CREATE INDEX IFK_Cycle2CycleParameter ON PARAMETER (CYCLE_ID);
...
CREATE INDEX IFK_DayGroup2SpecialDay ON SPECIAL_DAY (DAY_GROUP_ID);
...
CREATE INDEX FK_BATCH_PARAMETER_PARAMETER_ID ON BATCH_PARAMETER (PARAMETER_ID);
CREATE UNIQUE INDEX BATCH_PARAMETER_NAME_TYPE ON BATCH_PARAMETER (NAME, PARAMETER_TYPE);


CREATE INDEX IFK_Parameter2BatchParameter ON BATCH_PARAMETER (PARAMETER_ID);
