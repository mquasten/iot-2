...
class UserController {
	...
	String changePassword(@ModelAttribute(USER_MODEL_AND_VIEW_NAME) @Valid final UserModel user, final BindingResult bindingResult, final Model model, final Locale locale) {
